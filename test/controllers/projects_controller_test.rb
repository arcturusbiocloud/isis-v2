...
class ProjectsControllerTest < ActionController::TestCase
  ...
  test "should create project" do
    assert_difference('Project.count') do
      post :create, project: { name: 'My project', description: 'Super cool', is_public: true, design: 'source-code' }
    end
  ...
  test "should update project" do
    patch :update, id: @project, project: { name: 'Updated project', description: 'New description', is_public: false, design: 'source-code v2' }
    assert_redirected_to project_path(assigns(:project))
  end
